...
---
* NOTE: If the textures fail to load, please refresh the page once fully loaded. This demo is only to show that WEBGL can handle the necessary bases to create the classroom.

#### Contribute
* If you believe this is possible, if you like computer graphics and if you would like to have fun exploring this idea, please contact me via my personal email! :)